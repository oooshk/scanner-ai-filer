...
- `scanner_user_a` -> `/home/pi/scanner/inbox/user_a`
- `scanner_user_b` -> `/home/pi/scanner/inbox/user_b`
...
- Share: `scanner_user_a` @ `\\pi.local\scanner_user_a`  
   User: `user_a` / Password: (set during setup)

- Share: `scanner_user_b` @ `\\pi.local\scanner_user_b`  
...
- **Scanner for UserA**: Connect to `\\pi.local\scanner_user_a` with username `user_a`
- **Scanner for UserB**: Connect to `\\pi.local\scanner_user_b` with username `user_b`
...
- `scanner_user_a` -> `/home/pi/scanner/inbox/user_a/` -> `Filing/UserA/`
- `scanner_user_b` -> `/home/pi/scanner/inbox/user_b/` -> `Filing/UserB/`
- `scanner_user_c` -> `/home/pi/scanner/inbox/user_c/` -> `Filing/UserC/`

### Scanner Workflow

1. Configure your office scanner to use `\\pi.local\scanner_user_a`
2. Scan documents (invoices, statements, etc.)
3. Documents are temporarily stored in `/home/pi/scanner/inbox/user_a/`
