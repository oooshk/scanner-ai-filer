...
CRED_FILE="${CRED_FILE:-/home/pi/.smb-nas}"
...
FSTAB_LINE="//$NAS_HOST/$NAS_SHARE $MOUNT_POINT cifs credentials=$CRED_FILE,uid=$(id -u pi),gid=$(id -g pi),iocharset=utf8,vers=3.0,nofail,x-systemd.automount,_netdev 0 0"
